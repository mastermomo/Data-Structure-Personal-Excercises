 ...
 * This class serves as a HW exercise for chapter 19 for my CSC 202 class.
 * It functions to take an unordered array of integers and orders them from 
 * smallest to largest. The correct order is then provided to the user.
 */
public class SelectionSortArrayList {
    ...
    */
    public static void main(String[] args) {
        ...
        SelectionSortArrayList.<Integer>selectionSort(list); // Calls on a method to sort the integers from smallets to largest.
        
        System.out.println(list); // Prints the ordered array.
    }
