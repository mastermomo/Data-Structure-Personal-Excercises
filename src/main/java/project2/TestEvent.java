...
public class TestEvent {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        calendar.set(2018, 7 - 1, 28, 10, 0);  // 07/28/2018, 10:00
        ...
        calendar.set(2018, 7 - 1, 29, 13, 30);  // 07/29/2018, 13:30
        dateTime = calendar.getTime();
        ...
        calendar.set(2018, 8 - 1, 1, 13, 0);  // 08/01/2018, 13:00
        dateTime = calendar.getTime();
        ...
        calendar.set(2018, 8 - 1, 1, 20, 0);  // 08/01/2018, 20:00
        dateTime = calendar.getTime();
        ...
        calendar.set(2018, 8 - 1, 2, 10, 0);  // 08/02/2018, 10:00
        dateTime = calendar.getTime();
        ...
        calendar.set(2018, 8 - 1, 2, 20, 30);  // 08/02/2018, 20:30
        dateTime = calendar.getTime();
        ...
        calendar.set(2018, 8 - 1, 3, 10, 30);  // 08/03/2018, 10:30
        dateTime = calendar.getTime();
