...
public class TestEvent {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        new Concert("Folk Festival", "Browns Island", dateTime, 900, new String[]{"The Green Fields of America", "Be’la Dona", "Dale Ann Bradley"} , "Folk Music", new Weather(false, 85.0, 2.0, 0.5));
