...
public class BasketBallGame extends SportEvent {
    ...
    private static ArrayList<BasketBallGame> eventList = new ArrayList<BasketBallGame>(); // Creates an ArrayList object.
    ...
    public String toString() {
        return "[class = BasketBallGame" + ", name = " + name + ", place = " + place + ", date/time = " + this.getDateTimeString() + ", " + BasketBallGame.isWeekEnd(dateTime) + ", audience = " + audiance + 
