...
public class SoccerGame extends SportEvent implements GoodWeather {
    ...
    private static ArrayList<SoccerGame> eventList = new ArrayList<SoccerGame>(); // Creates an ArrayList object.
    /**
    ...
    public String toString() {
       return "[class = SoccerGame" + ", name = " + name + ", place = " + place + ", date/time = " + this.getDateTimeString() + ", " + SoccerGame.isWeekEnd(dateTime) + ", audience = " + audiance + 
                "] [teams = " + teams[0] + " vs " + teams[1] + ", scores = " + scores[0] + " - " + scores[1] + ", " + SoccerGame.whoWon(scores) + ", league = " 
               + league + "] [" + (this.isGoodWeather() ? "Good Weather" : "Bad Weather") + "]";               
    }
}
