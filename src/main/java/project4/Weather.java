...
public class Weather {
    ...
    public final void setSunny(boolean sunny) {
        this.sunny = sunny;
    }
    ...
    public boolean isGoodWeather() {
        return this.isSunny() && (this.getTemperature() >= 60.0 && this.getTemperature() <= 95.0) && this.getWindSpeed() <= 10.0 && (this.getHumidity() >= 0.4 && this.getHumidity() <= 0.8);
    }
