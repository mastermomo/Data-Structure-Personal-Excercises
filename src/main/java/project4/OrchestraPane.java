...
public class OrchestraPane extends GridPane {
    ...
    protected OrchestraPane() {
        ...
        super.add(new Label("Performancers:"), 2, 2);
        super.add(this.getTfPerformers(), 3, 2);
        super.add(new Label("Casual Attire:"), 0, 3);
        super.add(this.getHBoxCasualAttire(), 1, 3);
        super.add(btClear, 0, 4);
        super.add(btSubmit, 2, 4);
    ...
    public final RadioButton getRbCasualAttireYes() {
        return this.rbCasualAttireYes;
    }

    public final RadioButton getRbCasualAttireNo() {
        return this.rbCasualAttireNo;
    }

    public final ToggleGroup getCasualAttireGroup() {
        return this.casualAttireGroup;
    }

    public final HBox getHBoxCasualAttire() {
        return this.hBoxCasualAttire;
    }
    ...
    public void submit() {
        ...
        try {
            event = new Orchestra(name, place, dateTime, audience, performers, this.getRbCasualAttireYes().isSelected());
        } 
        catch (ParseException ex) {
        }
