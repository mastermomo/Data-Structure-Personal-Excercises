...
public final class StatisticsPane extends BorderPane {
    ...
    protected StatisticsPane() {
        ...
        gridPane.add(this.getTfEvents(), 1, 0);
        gridPane.add(new Label("Sport Events:"), 0, 1);
        gridPane.add(this.getTfSportEvents(), 1, 1);
        gridPane.add(new Label("Music Events:"), 2, 1);
        gridPane.add(this.getTfMusicEvents(), 3, 1);
        gridPane.add(new Label("Art Events:"), 4, 1);
        gridPane.add(this.getTfArtEvents(), 5, 1);
        gridPane.add(new Label("Soccer Games:"), 0, 2);
        gridPane.add(this.getTfSoccerGames(), 1, 2);
        gridPane.add(new Label("Basketball Games:"), 2, 2);
        gridPane.add(this.getTfBasketBallGames(), 3, 2);
        gridPane.add(new Label("Concerts:"), 0, 3);
        gridPane.add(this.getTfConcerts(), 1, 3);
        gridPane.add(new Label("Orchestras:"), 2, 3);
        gridPane.add(this.getTfOrchestras(), 3, 3);
        gridPane.add(btClear, 0, 4);
        gridPane.add(btCount, 2, 4);
    ...
    public TextField getTfEvents() {
        return this.tfEvents;
    }

    public TextField getTfSportEvents() {
        return this.tfSportEvents;
    }

    public TextField getTfMusicEvents() {
        return this.tfMusicEvents;
    }

    public TextField getTfArtEvents() {
        return this.tfArtEvents;
    }

    public TextField getTfSoccerGames() {
        return this.tfSoccerGames;
    }

    public TextField getTfBasketBallGames() {
        return this.tfBasketBallGames;
    }

    public TextField getTfConcerts() {
        return this.tfConcerts;
    }

    public TextField getTfOrchestras() {
        return this.tfOrchestras;
    }

    public TextArea getTaDisplayEvents() {
        return this.taDisplayEvents;
    }
    ...
    public void count() {
        ...
        while (eventListIterator.hasNext()) {
            ...
            events = events + "Event " + eventNumber + ": Class: " + event.getClass().getSimpleName() + ",\tEvent Name: " + event.getName() + "\n";
        }  
